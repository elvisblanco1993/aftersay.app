...
return [
    ...
    'notifications' => [
        'notifications' => [
            ...
            \Spatie\Backup\Notifications\Notifications\BackupWasSuccessfulNotification::class => [], // no notification when successful
