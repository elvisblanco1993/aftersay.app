...
<div x-data="{{ json_encode(['show' => true, 'style' => $style, 'message' => $message]) }}"
    :class="{ 'bg-green-500': style == 'success', 'bg-red-700': style == 'danger', 'bg-blue-600': style == 'warning', 'bg-slate-500': style != 'success' && style != 'danger' && style != 'warning'}"
            style="display: none;"
            x-show="show && message"
            x-on:banner-message.window="
                ...
                show = true;
            ">
    <div class="max-w-full xl:max-w-screen-2xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between flex-wrap">
            ...
            <div class="shrink-0 sm:ms-3">
                <button
                    ...
                    :class="{ 'hover:bg-green-600 focus:bg-green-600': style == 'success', 'hover:bg-red-600 focus:bg-red-600': style == 'danger', 'hover:bg-blue-700 focus:bg-blue-700': style == 'warning'}"
                    aria-label="Dismiss"
