...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware([
         ...
         */
        Route::get('concerns', \App\Livewire\Concern\Index::class)->name(
            'concern.index',
        );
        Route::get(
            'concerns/{concern}',
            \App\Livewire\Concern\Show::class,
        )->name('concern.show');

        /**
         * Link management routes
         */
        Route::get('workflows', \App\Livewire\Workflow\Index::class)->name(
            'workflow.index',
        );
        Route::get(
            'workflows/{workflow}',
            \App\Livewire\Workflow\Show::class,
        )->name('workflow.show');

        /**
         * Template management routes
         */
        Route::get('templates', \App\Livewire\Template\Index::class)->name(
            'template.index',
        );
        Route::get(
            'templates/{template}/update',
            \App\Livewire\Template\Update::class,
        ...
        Route::prefix('settings')->group(function () {
            ...
            Route::get('page', \App\Livewire\Page\Manage::class)->name(
                'settings.page',
            );
            Route::get('platforms', \App\Livewire\Platform\Index::class)->name(
                'settings.platforms',
            );
            Route::get('api-tokens', ApiTokens::class)->name(
                'settings.api-tokens',
            );
